    ...
    <div className="min-h-full pb-40">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 px-4">
          ...
          >
            <StarIcon className="h-4 w-4" filled={page.isFavorite} />
          </button>
      ...
      {page.coverColor && (
        <div className="group relative h-40 w-full" style={{ background: page.coverColor }}>
      ...
      <div className="mx-auto max-w-3xl px-12">
        <div className={`group flex items-center gap-2 ${page.coverColor ? "-mt-8" : "pt-8"}`}>
          <div className="relative">
            <button
        ...
        <textarea
          ...
          onKeyDown={(e) => {
            if (e.key === "Enter") {
              e.preventDefault();
              document.getElementById(`block-${page.blocks[0]?.id}`)?.focus();
            }
          }}
